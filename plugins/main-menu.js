 ...
 if (teks == 'nsfw') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	rows: [
	    {title: `📛)ഒ Info Bot`, rowId: ".info", description: "✧ Info nya Whatsapp BOT ><"},
	...
	{title: `💻)ഒ Bot Stats`, rowId: ".botinfo", description: "✧ Menampilkan Status 赤 Whatsapp - BOT"},
...
const listMessage = {
 ...
 let mode = global.opts['self'] ? 'Private' : 'Publik'
    ...
    let after = conn.menu.after || (conn.user.jid == global.conn.user.jid ? '' : `Powered by Naufal Muflih`) + defaultMenu.after
    let _text = [
      before,
